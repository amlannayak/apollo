...
CRED_FNAME = '/Users/amlan/Documents/playground/apollo/keys/Apollo-9151c552c2ec.json'
...
def make_channel(host):
    ...
    #credentials = service_account.Credentials.from_service_account_file(CRED_FNAME)
    #credentials = google.oauth2.credentials.Credentials("AIzaSyBsnVr8D3qCywKHlEQm29Z_KtrUyfVBUaM")
...
def listen_print_loop(
    ...
    for resp in recognize_stream:
        ...
        if not result.is_final:
            ...
            # AMLAN: If keyword "Apollo" is uttered, mute the speaker
            # to listen for subsequent command(s)
            if re.search(r'\b(spotify)\b', transcript, re.I):
            ...
            # one of our keywords.
                ...
                break
            # AMLAN: capturing the transcribed phrase for later use
            else:
                phrase = str(transcript + overwrite_chars)
                if(apl.parseCommand(phrase)):
